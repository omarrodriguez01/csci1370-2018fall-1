...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname soln-lab3) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; For each:
; DESIGN RECIPE
; 1. Data definitions (GIVEN)
